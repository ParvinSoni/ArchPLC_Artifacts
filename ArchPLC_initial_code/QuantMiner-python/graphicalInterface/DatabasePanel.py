...
class DatabasePanel():
 ...
 #GEN-END:initComponents
    ...
    # Method to override in the daughter class to trigger validation (storage, analysis, ...)
    # of the information entered in the panel fields (symmetrical to the previous method):
