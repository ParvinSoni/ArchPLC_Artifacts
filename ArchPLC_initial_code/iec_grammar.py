...
def _library_element_declaration(): return [data_type_declaration, function_declaration, function_block_declaration, data_block_declaration, program_declaration, configuration_declaration, global_var_declarations]
...
def version_number_declaration(): return (keyword('VERSION'), ':', _numeric_literal)
...
def function_declaration(): return (keyword('FUNCTION'), derived_function_name, ':', [_elementary_type_name, derived_type_name], -1, [_io_var_declarations, function_var_decls, _other_var_declarations], [function_body, unknown_in_function], keyword('END_FUNCTION'), 0, ';')
...
def data_block_body(): return [sequential_function_chart, statement_list]
def data_block_type_name(): return [standard_data_block_name, derived_data_block_name]
def standard_data_block_name(): return _identifier
def derived_data_block_name(): return _identifier
def data_block_begin(): return keyword('BEGIN')
def data_block_declaration(): return ([keyword('DATA_BLOCK'), keyword('DATABLOCK')], derived_data_block_name, 0, (keyword('TITLE'), '=', _character_string), 0, [retain, non_retain], simple_type_name, -1, [data_block_begin, _io_var_declarations, _other_var_declarations], [data_block_body, unknown_in_data_block], [keyword('END_DATA_BLOCK'), keyword('END_DATABLOCK')], 0, ';')
...
def program_access_decl(): return (access_name, ':', _symbolic_variable, ':', non_generic_type_name, 0, direction)
...
def unknown_in_data(): return re.compile(r"(?s).*?(?=END_DATA)")
def unknown_in_data_block(): return re.compile(r"(?s).*?(?=END_DATA_BLOCK)")
...
def action(): return (keyword('ACTION'), action_name, ':', [function_block_body, data_block_body, unknown_in_action], keyword('END_ACTION'), 0, ';')
def entry_action(): return (keyword('ENTRY_ACTION'), [function_block_body, data_block_body, unknown_in_action], keyword('END_ACTION'), 0, ';')
def exit_action(): return (keyword('EXIT_ACTION'), [function_block_body, data_block_body, unknown_in_action], keyword('END_ACTION'), 0, ';')
...
def access_path(): return [(0, (resource_name, '.'), direct_variable), (0, (resource_name, '.'), 0, (program_name, '.'), -1, (fb_name, '.'), _symbolic_variable)]
...
def program_output_reference(): return (program_name, '.', _symbolic_variable)
...
def prog_cnxn(): return [(_symbolic_variable, ':=', prog_data_source), (_symbolic_variable, '=>', data_sink)]
...
def il_operator_jmpcn(): return keyword('JMPCN')
