...
# input_file = open("FT_NewLog_Normal2.csv")
# input_file = open("FT_NewLog_Normal3.csv")
input_file = open("IOtrace_attack1_removed_benign_added_malicious_manually.csv")
        ...
        for sample in samples_list:
            ...
            if ALL_ELEMENTS_EXIST:
                for rt in rule_target:
                    ...
                    # print("**")
                    # print("row_value:" + str(row_value) + ", rt_value[0]:" + str(rt_value[0]) + ", tolerance_thresh:"+str(tolerance_thresh) + ", rt_value[1]:" + str(rt_value[1]))
                    # print("row_value:" + str(type(row_value).__name__) + ", rt_value[0]:" + str(type(rt_value[0]).__name__) + ", tolerance_thresh:"+str(type(tolerance_thresh).__name__) + ", rt_value[1]:" + str(type(rt_value[1]).__name__))    
                    ...
                    try:
                        ...
                        try:
                            insideInterval = row_value.lower() ==  rt_value[0].lower() or row_value.lower() ==  rt_value[1].lower()
                        except:
                            insideInterval = False
